export const services = {
  ...
  $defs: {
      ...
      properties: {
        ...
        collections: {
          ...
          additionalProperties: {
            $ref: "#/$defs/FeatureTypeConfigurationOgcApi",
          },
        },
      },
    ...
    PropertyTransformation: {
      ...
      properties: {
        ...
        reduceStringFormat: {
          ...
          description:
            "Reduces an object to a string using the same syntax as `stringFormat` but with     additional replacements for objects property names.",
          type: ["string", "number", "boolean", "null"],
        },
        stringFormat: {
          title: "stringFormat",
    ...
    TileProvider: {
      ...
      properties: {
        type: {
          enum: ["FEATURES", "MBTILES", "TILESERVER"],
        },
      },
      required: ["type"],
      allOf: [
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/TileProviderTileServer",
          },
        },
      ],
    },
    ...
    SchemaConfiguration: {
      ...
      properties: {
        ...
        versions: {
          title: "versions",
          description:
            "List of enabled JSON Schema versions. Supported are 2020-12 (`V202012`), 2019-09     (`V201909`) and 07 (`V7`).",
          allOf: [
            {
              if: {
                type: "array",
    ...
    GltfConfiguration: {
      ...
      properties: {
        ...
        properties: {
          ...
          type: "object",
          additionalProperties: {
            $ref: "#/$defs/GltfPropertyDefinition",
          },
        },
        withSurfaceType: {
    ...
    JsonFgConfiguration: {
      ...
      properties: {
        ...
        includeInGeoJson: {
          ...
          description:
            "The option allows selected JSON-FG extensions to be included in the GeoJSON encoding as     well. Allowed values are: `describedby`, `featureType`, `time`, `place`, `coordRefSys`,     `links`.",
          allOf: [
            {
              if: {
                type: "array",
      ...
      allOf: [
        {
          ...
          then: {
            $ref: "#/$defs/CollectionsConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/QueryablesConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/CityJsonConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/FeaturesCoreConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/FeaturesHtmlConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/FoundationConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/TileMatrixSetsConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/GeometrySimplificationConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/ProjectionsConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/FeaturesExtensionsConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/FlatgeobufConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/GeoJsonLdConfiguration",
          },
        },
        {
          if: {
        ...
        },
        {
          ...
          then: {
            $ref: "#/$defs/ResourcesConfiguration",
          },
        },
        {
          if: {
