  ...
  anyOf: [
    {
      properties: {
        providerSubType: {
          enum: ["MBTILES", "WFS", "HTTP", "FEATURES", "SQL"],
        },
      },
      required: ["providerSubType"],
    },
    {
      required: ["featureProviderType"],
      properties: {
        featureProviderType: {
          enum: ["WFS", "SQL"],
        },
  ...
  allOf: [
    {
      if: {
        ...
        required: ["providerType", "providerSubType"],
      },
      then: {
    ...
    },
    {
      if: {
        ...
        required: ["providerType", "featureProviderType"],
      },
      then: {
        $ref: "#/$defs/FeatureProviderWfsData",
      },
  ...
  $defs: {
    FeatureProviderWfsData: {
      ...
      properties: {
        ...
        extensions: {
          title: "extensions",
          description: "Definition of extensions, see [Extensions](extensions/README.md).",
          allOf: [
            {
              if: {
                type: "array",
        ...
        fragments: {
          title: "fragments",
          description:
            "Definition of reusable schema fragments that can be referenced using `schema` in     `types`. The entries are arbitrary [schema definitions](#schema-definitions).",
          type: "object",
        ...
        autoTypes: {
          title: "autoTypes",
          description:
            "List of source types to include in derived `types` definitions when `auto: true`.     Currently only works for [SQL](sql.md).",
          allOf: [
            {
              if: {
                type: "array",
        ...
        types: {
          title: "types",
          description:
            "Definition of feature types. The entries have to be [schema     definitions](#schema-definitions) with `type: OBJECT` and at least one property with `role:     ID`.",
          type: "object",
          additionalProperties: {
            $ref: "#/$defs/FeatureSchema",
          },
    ...
    FeatureProviderSqlData: {
      ...
      properties: {
        ...
        sourcePathDefaults: {
          ...
          description:
            "Defaults for the path expressions in `sourcePath`, for details see [Source Path     Defaults](#source-path-defaults) below.",
          type: "object",
        ...
        queryGeneration: {
          ...
          description:
            "Options for query generation, for details see [Query Generation](#query-generation)     below.",
          type: "object",
    ...
    TileProviderFeaturesData: {
      ...
      properties: {
        ...
        layerDefaults: {
          title: "layerDefaults",
          description: "*Deprecated* See `tilesetDefaults`.",
          type: "object",
          deprecated: true,
          $ref: "#/$defs/TilesetFeaturesDefaults",
        },
        ...
        layers: {
          title: "layers",
          description: "*Deprecated* See `tilesets`.",
          type: "object",
          deprecated: true,
          additionalProperties: {
            $ref: "#/$defs/TilesetFeatures",
    ...
    TileProviderHttpData: {
      ...
      description:
        "# HTTP  With this tile provider, the tiles are obtained via HTTP, e.g. from a     [TileServer-GL](https://github.com/maptiler/tileserver-gl) instance.       ## Configuration       {@docTable:properties }       {@docVar:tilesetDefaults }       {@docTable:tilesetDefaults }       {@docVar:tileset }       {@docTable:tileset }       ## Example       {@docVar:examples }",
      type: "object",
      properties: {
        id: {
          title: "id",
    ...
    FeatureChangesPgConfiguration: {
      ...
      description:
        "```yaml  - type: FEATURE_CHANGES_PG   enabled: true   listenForTypes: # optional, default is to listen for all types   - governmentalservice   pollingInterval: 30s # optional, default is 60s  ```",
      type: "object",
      properties: {
        type: {
          title: "type",
        ...
        pollingInterval: {
          ...
          description:
            "Since the JDBC driver for PostgreSQL does not support real reactivity, it has to be     polled for changes with the given interval.",
          type: ["string", "number", "boolean", "null"],
        },
      },
      additionalProperties: false,
    ...
    RoutesConfiguration: {
      ...
      properties: {
        ...
        fromToQuery: {
          title: "fromToQuery",
          description:
            "*Required* The SQL query to determine the start and end vertex of the route. `${point}`     will be replaced with the WKT POINT geometry of the waypoint to use as start/end.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
        ...
        edgesQuery: {
          title: "edgesQuery",
          description:
            "*Required* The SQL query to determine the edges / route segments of the route.     `${cost_column}` and `${reverse_cost_column}` will be replaced with the column names to use     for optimizing the route. `${cost_column}` is the value in the direction of the edge,     `${reverse_cost_column}` in the opposite direction.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
        ...
        flags: {
          title: "flags",
          description:
            "Additional flags that can be set to consider during the computation of the route. The     integer value of a flag must be a unique bit value.",
          type: "object",
          additionalProperties: {
            type: "number",
          },
        ...
        modes: {
          title: "modes",
          description:
            "Lists the available modes of transportation, the key is the mode id, the value a     descriptive label.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
        ...
        weightDefault: {
          title: "weightDefault",
          description:
            "Sets a default value for the weight of a vehicle in tons. `0` means no weight.",
          type: ["string", "number", "boolean", "null"],
        },
        heightDefault: {
          title: "heightDefault",
          description:
            "Sets a default value for the height of a vehicle in meters. `0` means no height.",
          type: ["string", "number", "boolean", "null"],
        },
        obstaclesDefault: {
        ...
        warmup: {
          title: "warmup",
          description:
            "Enables a route calculation with the default values at provider startup. This can be     useful, if the routing algorithm caches certain information.",
          oneOf: [
            {
              type: "boolean",
            },
    ...
    JsonSchemaConfiguration: {
      ...
      description:
        "```yaml  - type: JSON_SCHEMA   enabled: true   objectTypeRefs:     \u0027#/$defs/Link\u0027: Link  ```",
      type: "object",
      properties: {
        type: {
          title: "type",
        ...
        objectTypeRefs: {
          ...
          description:
            "Allows to map JSON schema definitions to an `objectType`, e.g. `\u0027#/$defs/Link\u0027: Link`.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
        ...
        geometryTypeRefs: {
          ...
          description:
            "Allows to map JSON schema definitions to a `geometryType`, e.g.     `https://geojson.org/schema/LineString.json\u0027: LINE_STRING`.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
        ...
        relationRefs: {
          title: "relationRefs",
          description:
            "Allows to map JSON schema definitions to a `refType`, e.g. `\u0027#/$defs/Address\u0027:     address`.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
    ...
    ExtensionConfiguration: {
      ...
      properties: {
        type: {
          enum: ["FEATURE_CHANGES_PG", "ROUTES", "JSON_SCHEMA"],
        },
      },
      required: ["type"],
      allOf: [
    ...
    SchemaConstraints: {
      ...
      description:
        "# Constraints  Currently only available in [German](../../de/providers/details/constraints.md).",
      type: "object",
      properties: {
        codelist: {
          title: "codelist",
    ...
    FeatureSchema: {
      ...
      properties: {
        ...
        sourcePath: {
          title: "sourcePath",
          description:
            "The relative path for this schema object. The syntax depends on the provider types, see     [SQL](sql.md#path-syntax) or [WFS](wfs.md#path-syntax).",
          type: ["string", "number", "boolean", "null"],
        },
        path: {
          title: "path",
        ...
        sourcePaths: {
          title: "sourcePaths",
          description:
            "The relative paths for this schema object. The syntax depends on the provider types,     see [SQL](sql.md#path-syntax) or [WFS](wfs.md#path-syntax).",
          allOf: [
            {
              if: {
                type: "array",
        ...
        schema: {
          title: "schema",
          description:
            "Reference to an external schema definition. The default resolver will resolve     references to entries in `fragments` e.g. `#/fragments/example`. For additional resolvers     see [Extensions](extensions).",
          type: ["string", "number", "boolean", "null"],
        },
        ignore: {
          title: "ignore",
        ...
        transformations: {
          ...
          description:
            "Optional transformations for the property, see     [transformations](../details/transformations.md).",
          allOf: [
            {
              if: {
                type: "array",
        ...
        constraints: {
          title: "constraints",
          description:
            "Optional description of schema constraints, especially for JSON schema generation. See     [Constraints](../details/constraints.md).",
          type: "object",
        ...
        coalesce: {
          title: "coalesce",
          description:
            "If the value for a property may come from more than one `sourcePath`, this allows to     choose the first non-null value. This takes a list of value schemas, for details see     [Mapping Operations](#coalesce).",
          allOf: [
            {
              if: {
                type: "array",
        ...
        concat: {
          title: "concat",
          description:
            "If the values for an array property may come from more than one `sourcePath`, this     allows to concatenate all available values. This takes a list of value or value array     schemas, for details see [Mapping Operations](#concat).",
          allOf: [
            {
              if: {
                type: "array",
    ...
    SqlPathDefaults: {
      ...
      properties: {
        primaryKey: {
          title: "primaryKey",
          description:
            "The default column that is used for join analysis if no differing primary key is set in     the [sourcePath](#path-syntax).",
          type: ["string", "number", "boolean", "null"],
        },
        defaultPrimaryKey: {
        ...
        sortKey: {
          title: "sortKey",
          description:
            "The default column that is used to sort rows if no differing sort key is set in the     [sourcePath](#path-syntax).",
          type: ["string", "number", "boolean", "null"],
        },
        defaultSortKey: {
        ...
        schema: {
          title: "schema",
          description:
            "The default schema that is applied to tables without prefix in     [sourcePaths](#path-syntax).",
          type: ["string", "number", "boolean", "null"],
        },
    ...
    ConnectionInfoSql: {
      ...
      properties: {
        ...
        database: {
          title: "database",
          description:
            "The name of the database. For `GPKG` the file path, either absolute or relative to the     [data folder](../../application/30-data-folder.md).",
          type: ["string", "number", "boolean", "null"],
        },
        host: {
          title: "host",
        ...
        driverOptions: {
          title: "driverOptions",
          description:
            "Custom options for the JDBC driver. For `PGIS`, you might pass `gssEncMode`, `ssl`,     `sslmode`, `sslcert`, `sslkey`, `sslrootcert` and `sslpassword`. For details see the     [driver     documentation](https://jdbc.postgresql.org/documentation/head/connect.html#connection-parameters).",
          type: "object",
          additionalProperties: {
            type: "string",
          },
    ...
    TilesetFeaturesDefaults: {
      ...
      description:
        "### Tileset Defaults       Defaults that are applied to each [Tileset](#tileset).",
      type: "object",
      properties: {
        center: {
          title: "center",
    ...
    TilesetFeatures: {
      ...
      description:
        "### Tileset       All options from [Tileset Defaults](#tileset-defaults) are also available and can be     overriden here.",
      type: "object",
      properties: {
        id: {
          title: "id",
    ...
    TilesetHttpDefaults: {
      ...
      properties: {
        ...
        encodings: {
          title: "encodings",
          description:
            "Supported tile encodings. Keys have to be one of `MVT`, `PNG`, `WebP` and `JPEG`,     values are provided as `{{fileExtension}}` in `urlTemplate`.",
          type: "object",
          additionalProperties: {
            type: "string",
          },
    ...
    TilesetHttp: {
      ...
      properties: {
        ...
        urlTemplate: {
          title: "urlTemplate",
          description:
            "URL template for accessing tiles. Parameters to use are `{{tileMatrix}}`,     `{{tileRow}}`, `{{tileCol}}` and `{{fileExtension}}`. Single curly braces are also allowed.",
          type: ["string", "number", "boolean", "null"],
        },
      },
      additionalProperties: false,
